  ...
  return (
    <div style={{ display: 'inline-block', position: 'relative' }}>
      <div className='signProp' {...bindHover(popupState)}>
        <Typography variant="h8" sx={{ display: 'flex', alignItems: 'center', gap: '4px', whiteSpace: 'nowrap' }}>
          Hello, SignIn
        </Typography>
        <Typography variant="h7" sx={{ display: 'flex', alignItems: 'center', gap: '4px', cursor: 'pointer', whiteSpace: 'nowrap' }}>
          Account & Lists
          <ArrowDropDownIcon />
        </Typography>
      </div>
