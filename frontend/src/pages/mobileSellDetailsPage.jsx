  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      try {
        ...
        const authToken = auth.token; // Assuming your auth context provides the token
        const headers = {
  ...
  return (
    <>
      ...
      >
        ...
        <Divider
          sx={{ width: "100%", height: "1px", bgcolor: "gray", mb: 2 }}
        />
        <Box
          sx={{
            width: "70%",
        ...
        >
          <DialogContent sx={{ display: "flex", flexDirection: "column" }}>
            <FormControl error={!!errors.condition}>
              <FormLabel sx={{ textAlign: "left", mb: 1 }}>Condition</FormLabel>
              <RadioGroup
                row
            ...
            <Divider
              sx={{ mb: 2, width: "100%", height: "1px", bgcolor: "black" }}
            />
