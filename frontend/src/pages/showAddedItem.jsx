...
const AddedMobileList = () => {
  ...
  const fetchMobiles = async () => {
    try {
      const response = await axios.get('https://valo-deal-backend.vercel.app/sell/mobiles'); //  api/v1/
  ...
  const handleDelete = async (mobileId) => {
    try {
      await axios.delete(`https://valo-deal-backend.vercel.app/sell/mobiles/${mobileId}`);
